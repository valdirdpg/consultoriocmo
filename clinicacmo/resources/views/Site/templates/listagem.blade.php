    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="{{route('convenios.index')}}">Início</a></li>
...
<div id="main" class="container jumbotron">
    <div id="top" class="row">
        ...
        <form  action= "{{route($rotaSearch)}}" method="GET">
            <div class="col-md-5">
        ...
        <div class="col-md-3">
            <a href="{{route($rotaCreate)}}" class="btn btn-primary pull-right h2">
